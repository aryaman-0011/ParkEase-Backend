...
// Declares the RabbitMQ exchange/queue/binding so they exist when we publish.
// The notification-service also declares them — RabbitMQ is idempotent on declarations.
@Configuration
